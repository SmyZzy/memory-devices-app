...
async function initDatabase() {
  ...
  try {
    ...
    if (topicsCount[0].count === 0) {
      const topics = [
        [
          'Тема 1. Основные понятия и классификация запоминающих устройств',
          `<h3>Запоминающие устройства ЭВМ</h3>
<p>Запоминающие устройства (ЗУ) — это аппаратные компоненты компьютера, предназначенные для хранения данных и программ.</p>
<h4>Классификация по иерархии памяти:</h4>
<ul>
<li><strong>Регистры процессора</strong> — fastest, smallest, located inside CPU</li>
<li><strong>Кэш-память (L1, L2, L3)</strong> — SRAM-based, buffers between CPU and main memory</li>
<li><strong>Оперативная память (RAM)</strong> — DRAM-based, main working memory</li>
<li><strong>Внешняя память</strong> — HDD, SSD, optical discs, flash drives</li>
</ul>
<h4>Основные характеристики ЗУ:</h4>
<ul>
<li><strong>Ёмкость</strong> — объём хранимых данных (биты, байты, КБ, МБ, ГБ, ТБ)</li>
<li><strong>Быстродействие</strong> — время доступа, скорость чтения/записи</li>
<li><strong>Энергонезависимость</strong> — сохранение данных при отключении питания</li>
<li><strong>Стоимость</strong> — цена за единицу хранения</li>
</ul>`,
          null, 1
        ],
        [
          'Тема 2. Оперативная память (RAM)',
...
<li>Пропускная способность (ГБ/с)</li>
        ...
        [
          'Тема 3. Постоянные запоминающие устройства (ROM, BIOS, Flash)',
          `<h3>Постоянные запоминающие устройства</h3>
<p>ПЗУ — энергонезависимая память, предназначенная для хранения неизменяемых данных.</p>
<h4>Виды ПЗУ:</h4>
<ul>
<li><strong>ROM (Read-Only Memory)</strong> — только для чтения, данные записываются при производстве</li>
<li><strong>PROM</strong> — программируемое ПЗУ, однократная запись</li>
<li><strong>EPROM</strong> — стираемое ультрафиолетом ПЗУ</li>
<li><strong>EEPROM</strong> — электрически стираемое ПЗУ</li>
<li><strong>Flash Memory</strong> — современный тип EEPROM</li>
</ul>
<h4>BIOS/UEFI:</h4>
<ul>
<li>Базовая система ввода-вывода, хранится в Flash-памяти на материнской плате</li>
<li>Выполняет POST (Power-On Self-Test)</li>
<li>Загружает операционную систему</li>
<li>UEFI — современная замена BIOS с графическим интерфейсом</li>
</ul>
<h4>Flash-память:</h4>
<ul>
<li><strong>NOR Flash</strong> — быстрое случайное чтение, используется для кода</li>
<li><strong>NAND Flash</strong> — высокая плотность, используется в SSD, USB-флешках, картах памяти</li>
</ul>`,
          null, 3
        ],
        [
          'Тема 4. Внешние запоминающие устройства (HDD, SSD, оптические диски)',
          `<h3>Внешние запоминающие устройства</h3>
<p>Внешние ЗУ предназначены для долговременного хранения больших объёмов данных.</p>
...
<h4>Оптические диски:</h4>
<ul>
<li><strong>CD</strong> — 700 МБ</li>
<li><strong>DVD</strong> — 4.7–17 ГБ</li>
<li><strong>Blu-ray</strong> — 25–128 ГБ</li>
</ul>`,
          null, 4
        ]
      ];
