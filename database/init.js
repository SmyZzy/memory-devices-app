...
<li><strong>Аппаратный</strong> — отдельный RAID-контролер, производительнее</li>
    ...
    // УДАЛЯЕМ старые мини-тесты и создаем новые на основе лекций
    await conn.query('DELETE FROM mini_tests');
    
    const miniTests = [
      // ТЕМА 1: Оперативная память (Блочная организация)
      [1, 'Как называется совокупность микросхем для увеличения разрядности ЗУ?', 'Банк памяти', 'Модуль памяти', 'Кэш-память', 'Регистр', 'B'],
      [1, 'Какие схемы распределения разрядов адреса между банком и ячейкой существуют?', 'Только блочная', 'Блочная, циклическая, блочно-циклическая', 'Только последовательная', 'Параллельная и последовательная', 'B'],
      [1, 'В какой схеме распределения адреса номер банка b = A mod B (B - количество банков)?', 'Блочная', 'Циклическая', 'Блочно-циклическая', 'Параллельная', 'B'],
      [1, 'Сколько банков используется в примере памяти емкостью 512 слов по 128 слов в каждом?', '2 банка', '4 банка', '8 банков', '16 банков', 'B'],
      
      // ТЕМА 2: Кеш-память
      [2, 'Какой уровень кэш-памяти расположен ближе всего к процессору?', 'L2', 'L3', 'L1', 'Внешний кэш', 'C'],
      [2, 'Что такое cache hit (попадание в кэш)?', 'Ошибка при обращении к памяти', 'Успешное нахождение данных в кэш-памяти', 'Переполнение кэша', 'Очистка кэша', 'B'],
      [2, 'Что происходит при cache miss (промахе кэша)?', 'Данные удаляются', 'Данные загружаются из оперативной памяти', 'Происходит ошибка', 'Кэш очищается', 'B'],
      [2, 'Какой тип памяти используется в кэш-памяти?', 'DRAM', 'SRAM', 'Flash', 'ROM', 'B'],
      
      // ТЕМА 3: Накопители (HDD, SSD)
      [3, 'Какой тип памяти используется в SSD-накопителях?', 'Магнитный', 'NAND Flash', 'Оптический', 'MRAM', 'B'],
      [3, 'Какой интерфейс обеспечивает наибольшую скорость для SSD?', 'SATA', 'NVMe (PCIe)', 'IDE', 'USB 3.0', 'B'],
      [3, 'Что является недостатком HDD по сравнению с SSD?', 'Большая емкость', 'Наличие движущихся частей', 'Низкая стоимость', 'Широкая совместимость', 'B'],
      [3, 'Сколько бит на ячейку хранит память TLC?', '1 бит', '2 бита', '3 бита', '4 бита', 'C'],
      
      // ТЕМА 4: Системы RAID
      [4, 'Что означает аббревиатура RAID?', 'Random Access Integrated Disk', 'Redundant Array of Independent Disks', 'Rapid Access Internal Data', 'Redundant Application Interface Device', 'B'],
      [4, 'Какой уровень RAID обеспечивает только чередование без отказоустойчивости?', 'RAID 1', 'RAID 5', 'RAID 0', 'RAID 10', 'C'],
      [4, 'Какой уровень RAID использует зеркалирование данных?', 'RAID 0', 'RAID 5', 'RAID 1', 'RAID 2', 'C'],
      [4, 'Сколько минимум дисков требуется для RAID 5?', '2 диска', '3 диска', '4 диска', '5 дисков', 'B'],
    ];
    ...
    console.log('Mini tests updated with lecture-based questions');
